...
async function uploadFile() {
    ...
    try {
        const res = await fetch("/upload", { method: "POST" ,headers: {
...
// ==========================================
//  6. VISION (X-RAY) LOGIC
// ==========================================

function openVisionModal() {
    document.getElementById("visionModal").style.display = "flex";
    // Reset
    document.getElementById("xray-name").textContent = "";
    document.getElementById("visionOutput").style.display = "none";
    document.getElementById("visionLoading").style.display = "none";
    document.getElementById("runVisionBtn").disabled = true;
